        ...
        <div class="w-col w-col-8 w-col-small-8 w-col-tiny-8 w-sub-col-middle w-clearfix">
          <div class="w-row">
            ...
            <div class="w-col w-col-9 w-col-small-9 w-col-tiny-9">
              <input class="user-reward-value w-input back-reward-input-reward" type="tel" min="#{number_with_precision(source.minimum_value, precison: 2)}" placeholder="#{source.minimum_value > 0 ? number_with_precision(source.minimum_value, precison: 2) : '00,00'}">
            </div>
          </div>
          <div class="fontsize-smaller text-error u-marginbottom-20 w-hidden"><span class="fa fa-exclamation-triangle"></span> O valor do apoio mínimo é R$25,00</div>
        </div>
