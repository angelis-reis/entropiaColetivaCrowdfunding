class Payment < ActiveRecord::Base
  ...
  #after_create :send_thanks_contribution_mail
  ...
  def send_thanks_contribution_mail
    # TODO: fix sidekiq async
    #ThanksContributionSenderWorker.new.perform(self.contribution)
    ProjectMailer.thanks_contribution(self.contribution).deliver
  end
end
